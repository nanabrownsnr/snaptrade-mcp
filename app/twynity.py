...
def register_routes(mcp):
        ...
        return JSONResponse(
            {
                ...
                "endpoint": "/api/v1/snaptrade_connections",
                "method": "POST",
                "schema": {"client_id": "string", "consumer_key": "string"},
            }
        )
    ...
    async def configure(request: Request):
        ...
        if not payload.get("client_id") or not payload.get("consumer_key"):
            return JSONResponse(
                {"detail": "client_id and consumer_key are required"}, status_code=422
            )
        ...
        return JSONResponse(
            {
                ...
                "external_connections": {"project": {"name": "snaptrade_connections"}},
            }
        )
