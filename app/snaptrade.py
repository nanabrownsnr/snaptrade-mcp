    ...
    for account in accounts or []:
        ...
        for position in positions or []:
            ...
            normalized.append({
                ...
                "cost_basis": position.get("average_purchase_price") or position.get("cost_basis"),
...
def cash(owner_id: str) -> dict:
    ...
    for account in accounts or []:
        ...
        balances.append({"account_id": account_id, "account_type": account.get("type"), "balances": balance})
